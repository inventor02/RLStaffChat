...
public abstract class AbstractCommand {
    ...
    public String permissionMessage() {
        return MessageFormatUtil.formatInfoMessage(ChatColor.RED + "Insufficient permission - sorry, no dice.");
    }
    ...
    public String generateUsage() {
        return MessageFormatUtil.formatInfoMessage(ChatColor.RED + "Usage: /" + name() + " " + usage());
    }
    ...
    public final void handle(CommandSender sender, String[] args) {
        ...
        if (! canUse) {
            sender.sendMessage(MessageFormatUtil.formatInfoMessage(ChatColor.RED + "You can't use this one."));
            return;
        }
